...
# Carregar dados ---------------------------------------------------------
load('Dados/dados_indicadores.Rdata')
...
saveRDS(municipios, "Dados/dados_municipios.rds") #salavr em RDS para evitar ler o shapefile toda vez no Rmarkdown
municipios <- readRDS("Dados/dados_municipios.rds")
